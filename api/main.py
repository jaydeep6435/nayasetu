"""
FastAPI Application — the entry point for the NayaSetu API server.
...
async def serve_frontend():
    """Serve the NayaSetu frontend."""
    if ui_index.exists():
        return FileResponse(str(ui_index))
    return {"message": "NayaSetu API is running. Frontend not found at ui/index.html."}
